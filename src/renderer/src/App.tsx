...
function App(): JSX.Element {
  ...
  const notificationServiceRef: RefObject<NotificationService> = createRef()
  ...
  return (
    <>
      <NotificationCenter ref={notificationServiceRef} />
      {loading && (
        <Container
          fluid
      ...
      <NotificationContext.Provider value={notificationServiceRef}>
